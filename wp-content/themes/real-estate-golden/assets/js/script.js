...
jQuery(window).on('load', function( $ ){
    ...
    */
    ...
    var real_estate_golden_menu_is_focus = false;
/*
    jQuery(".mobile-menu li.has-sub-menu > a").on("click", function(e) {
        if(!real_estate_golden_menu_is_focus){
    ...
    jQuery(".mobile-menu li.has-sub-menu > a").on("focus", function(e) {
        jQuery(this).next("ul").slideToggle();
        real_estate_golden_menu_is_focus = true;
        setTimeout(()=>{ real_estate_golden_menu_is_focus = false;}, 500);
        return false;
    });
