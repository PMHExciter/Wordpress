...
function itre_scripts() {
	...
	wp_enqueue_script( 'video-bg-js', esc_url(get_template_directory_uri() . '/assets/js/jquery.youtube-background.js'), array('jquery'), ITRE_VERSION );

    //wp_enqueue_script( 'colorpalpha-js', esc_url(get_template_directory_uri() . '/assets/js/color-alpha.js'), array('jquery'), ITRE_VERSION, true );

	wp_enqueue_script( 'itre-navigation', esc_url(get_template_directory_uri() . '/assets/js/navigation.js'), array(), ITRE_VERSION );

	wp_enqueue_script( 'itre-custom-js', esc_url( get_template_directory_uri() . '/assets/js/custom.js'), array('jquery'), ITRE_VERSION );

	if (is_plugin_active("it-listings/it-listings.php")) {
		//wp_enqueue_script( 'itre-property-js', esc_url( get_template_directory_uri() . '/assets/js/property.js'), array('jquery'), ITRE_VERSION );

		// if ( is_singular(['property'])) {
        //
		// 	global $post;
        //
        //     wp_enqueue_script( 'itre-property-map-js', esc_url( get_template_directory_uri() . '/assets/js/property-map.js'), array('jquery'), ITRE_VERSION );
        //
