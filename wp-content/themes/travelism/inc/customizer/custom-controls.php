 ...
 */
class Travelism_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Travelism_Dropdown_Category_Control extends WP_Customize_Control {
...
class Travelism_Note_Control extends WP_Customize_Control {
...
class Travelism_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class Travelism_Dropdown_Chooser extends WP_Customize_Control{
 ...
 */
class Travelism_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class Travelism_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="travelism-sortable-list">
      ...
      ?>
      	<?php if ($options[$value.'_section_enable'] !== false ): ?>
	        <li>
	            <input class="travelism-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu travelism-drag-handle"></i>
	        </li>
        <?php endif; ?>
        <?php
          } // end choices.
        ...
        <li class="sortable-hideme">
          <input class="travelism-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Travelism_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
	            ...
	            <?php } ?>
	            <input id="travelism-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'travelism' ); ?>" class="travelism-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
...
class Travelism_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @since  1.0.0
 */
class Travelism_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Travelism_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
