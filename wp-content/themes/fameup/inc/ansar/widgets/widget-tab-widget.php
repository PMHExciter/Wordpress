        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">  
                    ...
                    <!-- small-list-post -->
                        ...
                        <div class="small-post-content">
                          <?php fameup_post_categories(); ?>
                          <!-- small-post-content -->
                          <h5 class="title"><a href="<?php echo get_permalink($postID); ?>"><?php echo get_the_title( $postID ); ?></a></h5>
                          <!-- // title_small_post -->
                          <?php fameup_post_meta(); ?>
                        </div>
                        <!-- // small-post-content -->
          ...
          <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        ...
                        <div class="small-post-content">
                          <?php fameup_post_categories(); ?>
                          <!-- small-post-content -->
                          <h5 class="title"><a href="<?php echo esc_url(get_permalink($postID)); ?>"><?php echo get_the_title( $postID ); ?></a></h5>
                          <!-- // title_small_post -->
                          <?php fameup_post_meta(); ?>
                        </div>
                        <!-- // small-post-content -->
  ...
  <!-- /widget end-->
	...
	public function form( $instance ) {
		...
		<p>
			 ...
			 <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'trending_title' ); ?>" name="<?php echo $this->get_field_name( 'trending_title' ); ?>" value="<?php echo esc_attr( $trending_title ); ?>" />
			 </label>
			
		</p>
		<p>
			<label>
				<?php esc_html_e('Select Trending Category', 'fameup' ); ?>:
				<?php
		...
		<p>
			 ...
			 <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'popular_title' ); ?>" name="<?php echo $this->get_field_name( 'popular_title' ); ?>" value="<?php echo esc_attr( $popular_title ); ?>" />
			 </label>
		</p>
		<p>
			<label>
				<?php esc_html_e( 'Select Popular Category', 'fameup' ); ?>:
				<?php
					wp_dropdown_categories(
						array(
							'show_option_all' => __('All categories', 'fameup' ),
		...
		<p>
			 <label for="<?php echo $this->get_field_id( 'latest_title' ); ?>">Latest Title :
			 <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'latest_title' ); ?>" name="<?php echo $this->get_field_name( 'latest_title' ); ?>" value="<?php echo esc_attr( $latest_title ); ?>" /></label>
		</p>
		<p>
			<label>
				<?php esc_html_e( 'Select Latest Category', 'fameup' ); ?>:
				<?php
					wp_dropdown_categories(
						array(
							'show_option_all' => __('All categories', 'fameup' ),
