...
function ocdi_import_files() {
	$pac_name = 'demo-content.pac';
    if (file_exists(get_template_directory() .'/addons')) {
	...
	return [
		[
			...
			'local_import_file'            => trailingslashit(get_template_directory()) . 'includes/ocdi/demo/'.$pac_name,
