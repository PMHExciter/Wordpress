		...
		<article class="wp-travel-default-article">
			<div class="wp-travel-article-image-wrap">
				...
				<?php if ( wptravel_tab_show_in_menu( 'reviews' ) ) : ?>
					...
					<span class="wp-travel-review-text"> (<?php printf( _n( '%d Review', '%d Reviews', $count, 'travelism' ), $count ); ?>)</span>
				<?php endif; ?>

				<?php if ( $enable_sale ) : ?>
					<div class="wp-travel-offer">
						<span><?php esc_html_e( 'Offer', 'travelism' ); ?></span>
					</div>
				<?php endif; ?>
			...
			<div class="wp-travel-entry-content-wrapper">
				<div class="description-left">
					...
					<header class="entry-header">
						<h2 class="entry-title">
							<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute( array( 'before' => __( 'Permalink to: ', 'travelism' ) ) ); ?>">
								<?php the_title(); ?>
							</a>
						</h2>
					</header><!-- .entry-header -->
					...
					<div class="entry-meta">
						<div class="category-list-items">
							<span class="post-category">
								...
								<?php if ( is_array( $terms ) && count( $terms ) > 0 ) : ?>
									...
									<a href="<?php echo esc_url( $term_link, 'travelism' ); ?>" rel="tag">
										...
										<div class="sub-category-menu">
											<?php foreach ( $terms as $post_term ) : ?>
												<?php
													...
													$term_link = get_term_link( $post_term->term_id, 'itinerary_types' ); ?>
												<a href="<?php echo esc_url( $term_link, 'travelism' ); ?>">
													<?php echo esc_html( $term_name ); ?>
												</a>
											<?php endforeach; ?>
										</div>
						...
						<div class="travel-info">
							<span class="group-size"><?php esc_html_e( 'No. of Travellers:', 'travelism' ); ?></span>
				...
				<div class="description-right">
					...
					<div class="travel-info">
						<span><?php esc_html_e( 'Duration:', 'travelism' ); ?></span>
						<?php wptravel_get_trip_duration( get_the_ID() ); ?>
					</div>

					<div class="wp-travel-explore">
						<a class="" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Explore', 'travelism' ); ?></a>
