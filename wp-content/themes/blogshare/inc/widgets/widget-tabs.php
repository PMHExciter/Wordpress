 ...
 * @since      1.0.0
 */
class blogshare_Tabs_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-blogshare-tabs widget_tabs posts-thumbnail-widget',
			'description' => __( 'Display popular & recent posts, comments and tags.', 'blogshare' )
		);

		// Create the widget.
		parent::__construct(
			'blogshare-tabs',                  // $this->id_base
			__( '&raquo; Tabs', 'blogshare' ), // $this->name
	...
	function widget( $args, $instance ) {
		...
		<ul class="horizontal">
			<li class="active"><a href="#tab1" title="<?php esc_attr_e( 'Popular', 'blogshare' ); ?>"><i class="fa fa-star"></i> <?php esc_html_e( 'Popular', 'blogshare' ); ?></a></li>
			<li><a href="#tab2" title="<?php esc_attr_e( 'Latest', 'blogshare' ); ?>"><i class="fa fa-clock"></i> <?php esc_html_e( 'Latest', 'blogshare' ); ?></a></li>
			<li><a href="#tab3" title="<?php esc_attr_e( 'Comments', 'blogshare' ); ?>"><i class="fa fa-comments"></i> <?php esc_html_e( 'Comments', 'blogshare' ); ?></a></li>        
			<li><a href="#tab4" title="<?php esc_attr_e( 'Tags', 'blogshare' ); ?>"><i class="fa fa-tag"></i> <?php esc_html_e( 'Tags', 'blogshare' ); ?></a></li>
		</ul>
			...
			<div id='tab1' class="tab-content widget-posts-thumbnail">
				<?php
					...
					$args = array(
						'posts_per_page' => $instance['popular_num'],
							...
							while ( $popular->have_posts() ) : $popular->the_post();
								...
								echo '<li class="clear">';
									...
									echo '<div class="thumbnail-wrap">';
										the_post_thumbnail('blogshare_widget_thumb');  
									echo '</div>';
	...
	?>
		...
		<p>
			<label for="<?php echo esc_html( $this->get_field_id( 'popular_num' ) ); ?>">
				<?php esc_html_e( 'Number of popular posts to show', 'blogshare' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_html( $this->get_field_id( 'recent_num' ) ); ?>">
				<?php esc_html_e( 'Number of recent posts to show', 'blogshare' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo esc_html( $this->get_field_id( 'comments_num' ) ); ?>">
				<?php esc_html_e( 'Number of recent comments to show', 'blogshare' ); ?>
			</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'day_limit' ); ?>">
				<?php _e( 'Show posts published within xx days', 'blogshare' ); ?>
			</label>
		...
		<p>
			...
			<label for="<?php echo esc_html( $this->get_field_id( 'show_number' )); ?>">
				<?php esc_html_e( 'Display number before post title?', 'blogshare' ); ?>
			</label>
		</p>	
 ...
 * @since 1.0.0
 */
function blogshare_popular_posts( $number = 6 ) {
 ...
 * @since 1.0.0
 */
function blogshare_latest_posts( $number = 6 ) {
