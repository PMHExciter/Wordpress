    ...
    class Fameup_Posts_Slider extends Fameup_Widget_Base
    {
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::fameup_generate_text_input('fameup-posts-slider-title', __('Title', 'fameup'), 'Posts Slider');
                ...
                <?php echo parent::fameup_generate_select_options('fameup-select-column', __('Select column', 'fameup'), $column);
            }
