...
class Travelism_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'travelism';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'travelism' ), $i ),
...
// Initialize.
$travelism_footer_widgets = new Travelism_Footer_Widgets();
